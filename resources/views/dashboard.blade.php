        ...
        <div class="py-12">
            ...
            <div class="flex flex-col m-auto p-auto">
                ...
                <div class="flex overflow-x-scroll pb-10 hide-scroll-bar lg:px-20 md:px-4 px-2 lg:mx-40 md:mx-12 mx-4">
                    <div class="max-w-sm rounded overflow-hidden shadow-lg">
                        ...
                        <div class="px-6 py-4">
                            <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">Universitas Gadjah Mada</span>
                            <a href="https://www.youtube.com/watch?v=pQnejArI-oA" class="inline-block bg-blue-500 rounded-full px-3 py-1 text-sm font-semibold text-slate-600 hover:bg-blue-700">Watch Video</a>
                        </div>
                    </div>  
            ...
            <div class="flex flex-col m-auto p-auto">
                ...
                @foreach ($doctors as $doctor)
                    <div class="flex overflow-x-scroll pb-4 hide-scroll-bar lg:px-20 md:px-4 px-2 lg:mx-40 md:mx-12 mx-4">
                        <div class="flex flex-nowrap lg:ml-0 md:ml-4 ml-4 ">
